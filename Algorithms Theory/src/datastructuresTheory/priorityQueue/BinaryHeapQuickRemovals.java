package datastructuresTheory.priorityQueue;

/**
 *  A BINARY HEAP BUT WITH THE IMPLEMENTATION OF HASH TABLE - for Logarithmic removal
 * 
 * A min priority queue implementation using a binary heap. 
 * This implementation tracks each element
...
public class BinaryHeapQuickRemovals<T extends Comparable<T>> {
  ...
  private Integer mapGet(T value) {
    ...
    TreeSet<Integer> set = map.get(value); //TreeSet in Java is implemented with Balance - BST -> logarithmic search
